...
// URI actuelle pour savoir si on est sur une page admin
    ...
    <div class="header-inner">
        ...
        <div class="nav-right">
            <?php if (isset($_SESSION['user_id'])): ?>
                ...
                <!-- Bouton Dashboard pour les admins uniquement hors pages /admin -->
                <?php if (isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'admin' && !str_starts_with($currentUri, '/admin')): ?>
